 ...
 * 
 * Given two arrays A and B of equal size N, the task is to 
 * find if given arrays are equal or not. Two arrays are said 
 * to be equal if both of them contain same set of elements, 
 * arrangements (or permutation) of elements may be different though.
    ...
    are equal else returns false.The 0 and 1 printing is done by the 
    driver code.
