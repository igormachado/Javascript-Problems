 ...
 * Given a linked list. Print all the elements of the linked list.
    ...
    Note :- End of Line is handled by driver code itself. 
    You just have to end with a single space.
    ...
    Your task is to complete the function display() 
    which takes the head of the linked list as input 
    and prints the linked list in a single line.
